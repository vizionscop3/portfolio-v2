...
import { logger, PerformanceMonitor, trackUserInteraction } from '../utils/logger';
    ...
    try {
                  ...
                  <div key={index} className="bg-white rounded-lg shadow-md p-6 hover:shadow-lg transition-shadow">
                    ...
                    <div className="flex gap-4">
                      <a 
                        ...
                        onClick={() => trackUserInteraction('project_github_click', { project: project.title })}
                      >
                        <Github size={16} />
                        Code
                      </a>
                      <a 
                        ...
                        onClick={() => trackUserInteraction('project_demo_click', { project: project.title })}
                      >
      ...
      return (
        <div className="text-center py-8">
          <p className="text-red-600">An error occurred while loading this section.</p>
        </div>
      );
    }
  };
