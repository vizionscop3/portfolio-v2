...
describe('Portfolio Component', () => {
  it('renders the portfolio component', () => {
    ...
    expect(
      screen.getByText('Full Stack Developer & Creative')
    ).toBeInTheDocument();
  });
  ...
  it('displays coming soon messages for incomplete sections', () => {
    ...
    const fashionNavButton = screen.getByTestId('nav-fashion-button');
    fireEvent.click(fashionNavButton);
    expect(
      screen.getByText('Fashion Portfolio Coming Soon')
    ).toBeInTheDocument();

    // Navigate to merch section
    const merchNavButton = screen.getByTestId('nav-merch-button');
    fireEvent.click(merchNavButton);
